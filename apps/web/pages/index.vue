    ...
    <div class="flex-1 flex items-center flex-col justify-center">
      ...
      <section class="max-w-xl w-full mx-auto py-16 pt-0 relative z-10">
        <div class="bg-gray-500/10 border border-gray-500/10 rounded-xl overflow-hidden relative z-10">
          ...
          <div class="bg-gray-500/10 p-4 px-5 h-[250px] relative">
            <button
              @click="copyCodeExample"
              class="p-2 text-gray-500 hover:text-white transition-colors absolute top-4 right-[5px]"
          ...
          <div v-if="codeExampleTab === 'node'" class="border-t border-gray-500/10 px-4 py-3 flex items-center justify-between">
